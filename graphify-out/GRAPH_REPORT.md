...
## Corpus Check
- 279 files · ~88,863 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1550 nodes · 2454 edges · 180 communities (148 shown, 32 thin omitted)
...
Cohesion: 0.14
Nodes (23): Breadcrumbs(), Crumb, MegaMenu(), MegaMenuTrigger(), Props, cache, CacheEntry, getCached() (+15 more)
...
Cohesion: 0.12
Nodes (23): FavoriteSeed, OrderSeed, categoryTree, CatSeed, clearGhostRowsForSlug(), customers, ensureCustomer(), legacyComments (+15 more)

### Community 9 - "AccountPage.tsx"
Cohesion: 0.17
Nodes (21): AccountPage, AddressFields(), Province, useAddressValidation(), Options, scrollSmooth(), useListingScrollReveal(), ORDER_STATUS_FA (+13 more)
...
Cohesion: 0.19
Nodes (18): CartDrawer(), CartLine, Props, Header(), Props, MiniCartDropdown(), Props, normalizeList() (+10 more)
...
Cohesion: 0.11
Nodes (20): App(), AppShell(), CartPage, CheckoutPage, CmsPage, loadCart(), PaymentCallbackPage, ProductPage (+12 more)
...
### Community 31 - "react"
Cohesion: 0.21
Nodes (8): InfiniteScrollSentinel(), Props, ListingPaginationFooter(), Props, pageNumbers(), PaginationBar(), Props, react
...
### Community 165 - "ShopPage.tsx"
Cohesion: 0.16
Nodes (22): CategoryFilterTree(), CategoryNode(), isActive(), nodeKey(), Props, CategoryItem, PaginatedSliceMode, PaginatedSliceOptions (+14 more)
...
Cohesion: 0.08
Nodes (37): callback(), createTicket(), getAccessToken(), getPaymentSettings(), PaymentSettings, refund(), resolveUser(), resolveUserPhone() (+29 more)
...
### Community 176 - "ListingSkeletons.tsx"
Cohesion: 0.29
Nodes (6): OrderRowSkeleton(), ProductCardSkeleton(), ProductGridSkeleton(), Props, ReviewSkeleton(), WishlistItemSkeleton()

### Community 177 - "mediaUrl"
Cohesion: 0.23
Nodes (12): mediaUrl(), pickFormatUrl(), convertMarkdownInline(), looksLikeHtml(), normalizeHtmlImages(), productDescriptionHtml(), resolveDescUrl(), DEFAULTS (+4 more)

### Community 179 - "resolveSeedCatalog"
Cohesion: 0.47
Nodes (6): bulkSeedSummary(), isBulkSeedEnabled(), localPx(), px(), resolveSeedCatalog(), seedHomepageSections()

## Knowledge Gaps
- **596 isolated node(s):** `/home/mas/Projects/gandom_galery_shop/scripts/graphify-mcp.sh`, `config`, `config`, `allowedMediaTypes`, `deniedExecutableTypes` (+591 more)
...
- **Why does `react` connect `react` to `SectionRenderer.tsx`, `ProductPage.tsx`, `ShopPage.tsx`, `plugins`, `AccountPage.tsx`, `index.jsx`, `format.ts`, `mediaUrl`, `App.tsx`, `ShopOwnerShell.tsx`?**
